  ...
  return (
    <section className="py-24 lg:py-32 bg-card relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <EditableText
            contentKey="future.body"
            as="p"
            label="Vision paragraph"
            multiline
            className="text-cream/80 text-lg lg:text-xl leading-relaxed mb-6 max-w-3xl mx-auto"
            value={resolve(
              c,
              "future.body",
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {goals.map((goal) => (
            ...
            >
              ...
              />
              <EditableText
                contentKey={`future.goal.${goal.key}.desc`}
                as="p"
                label="Goal description"
                multiline
                className="text-cream/60 leading-relaxed"
                value={resolve(c, `future.goal.${goal.key}.desc`, goal.desc)}
              />
            </div>
          ))}
        </div>
