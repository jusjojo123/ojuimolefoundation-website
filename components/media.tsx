            ...
            {articles.length > 0
              ? articles.map((article) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      <span className="text-gold/60 text-xs tracking-wider uppercase">Article</span>
                      <h4 className="text-cream font-medium mt-2 mb-2">{article.title}</h4>
                      {article.description && (
                        <p className="text-cream/50 text-sm">{article.description}</p>
                      )}
                    </div>
                  </div>
                ))
