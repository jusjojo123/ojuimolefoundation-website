    ...
    <section id="gallery" className="py-24 lg:py-32 bg-background relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {/* Featured Images */}
          <div className="col-span-2 row-span-2 relative rounded overflow-hidden group">
            <div className="absolute inset-0 bg-muted">
              <Image
                src="/images/spiritual-heritage.jpg"
                alt="Spiritual heritage documentation"
                fill
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
              <p className="text-cream text-sm">Spiritual Heritage Documentation</p>
            </div>
          </div>
          ...
          {[
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-background/90 to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
                <p className="text-cream/80 text-xs">{title}</p>
              </div>
            </div>
          ))}
        </div>
