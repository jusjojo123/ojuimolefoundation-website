      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
          {contactInfo.map((item) => (
            <div
              key={item.label}
              className="bg-background/50 border border-gold/10 rounded p-8 text-center hover:border-gold/20 transition-colors"
            >
              ...
              <h3 className="font-heading text-lg text-cream mb-2">{item.label}</h3>
              {item.href ? (
                <a href={item.href} className="text-cream/60 hover:text-gold transition-colors text-sm">
                  {item.value}
                </a>
              ) : (
                <span className="text-cream/60 text-sm">{item.value}</span>
              )}
            </div>
          ))}
        </div>
        ...
        <div className="text-center">
          <h3 className="font-heading text-xl text-cream mb-6 tracking-wide">Follow Us</h3>
          <div className="flex justify-center gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-12 h-12 rounded-full bg-background border border-gold/20 flex items-center justify-center text-cream/60 hover:text-gold hover:border-gold/40 transition-colors"
